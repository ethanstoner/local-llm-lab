# Local LLM Lab: full results

The complete write-up behind the [README](../README.md): every phase, every table, and
the reasoning for each conclusion. The measurement decisions are in
[`methodology.md`](methodology.md) and the working log, failures included, is in
